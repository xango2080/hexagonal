...
public class ComputeGeolocalisationNextDepartureUseCase implements NextDepartureCalculator {

    private final SearchNextDeparture searchNextDeparture;
    private final NextDepartureCalculatorRequestValidator validator;

    public ComputeGeolocalisationNextDepartureUseCase(SearchNextDeparture searchNextDeparture, NextDepartureCalculatorRequestValidator validator) {
